...
public class FlexboxAndroidTest {
    ...
    @Test
    @FlakyTest(tolerance = TOLERANCE)
    public void testlDivider_directionRow_verticalBeginning() throws Throwable {
        final FlexboxTestActivity activity = mActivityRule.getActivity();
        mActivityRule.runOnUiThread(new Runnable() {
            @Override
            public void run() {
    ...
    @Test
    @FlakyTest(tolerance = TOLERANCE)
    public void testlDivider_directionRow_verticalMiddle() throws Throwable {
        final FlexboxTestActivity activity = mActivityRule.getActivity();
        mActivityRule.runOnUiThread(new Runnable() {
            @Override
            public void run() {
    ...
    @Test
    @FlakyTest(tolerance = TOLERANCE)
    public void testlDivider_directionRow_horizontalBeginning() throws Throwable {
        final FlexboxTestActivity activity = mActivityRule.getActivity();
        mActivityRule.runOnUiThread(new Runnable() {
            @Override
            public void run() {
        ...
        Drawable divider = ResourcesCompat
                .getDrawable(activity.getResources(), R.drawable.divider, null);
        assertNotNull(divider);
        int heightSum = text1.getHeight() + text4.getHeight() + divider.getIntrinsicWidth();
    ...
    @Test
    @FlakyTest(tolerance = TOLERANCE)
    public void testlDivider_directionRow_horizontalMiddle() throws Throwable {
        final FlexboxTestActivity activity = mActivityRule.getActivity();
        mActivityRule.runOnUiThread(new Runnable() {
            @Override
            public void run() {
    ...
    public void testDivider_directionRow_horizontalAll() throws Throwable {
        ...
        Drawable divider = ResourcesCompat
                .getDrawable(activity.getResources(), R.drawable.divider, null);
        assertNotNull(divider);
        int heightSum = text1.getHeight() + text4.getHeight() + divider.getIntrinsicWidth() * 3;
        assertThat(text4.getBottom() + divider.getIntrinsicHeight(), is(heightSum));
        assertThat(text1.getTop(), is(not(flexboxLayout.getTop())));
    }
    ...
    public void testDivider_directionRow_all_thickDivider() throws Throwable {
        ...
        mActivityRule.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                FlexboxLayout flexboxLayout = (FlexboxLayout) activity
                        .findViewById(R.id.flexbox_layout);
                Drawable thickDivider = activity.getDrawable(R.drawable.divider_thick);
        ...
        TextView text2 = (TextView) activity.findViewById(R.id.text2);
        TextView text3 = (TextView) activity.findViewById(R.id.text3);
        Drawable divider = activity.getDrawable(R.drawable.divider_thick);
    ...
    @Test
    @FlakyTest(tolerance = TOLERANCE)
    public void testlDivider_directionColumn_verticalBeginning() throws Throwable {
        final FlexboxTestActivity activity = mActivityRule.getActivity();
        mActivityRule.runOnUiThread(new Runnable() {
            @Override
            public void run() {
    ...
    @Test
    @FlakyTest(tolerance = TOLERANCE)
    public void testlDivider_directionColumn_verticalMiddle() throws Throwable {
        final FlexboxTestActivity activity = mActivityRule.getActivity();
        mActivityRule.runOnUiThread(new Runnable() {
            @Override
            public void run() {
